...
export default function PeriodontogramPage() {
  ...
  const filteredPeriodontograms = periodontograms.filter(periodontogram => {
    ...
    const matchesPatient = selectedPatientId === 'all-patients' || periodontogram.patient.id === selectedPatientId;
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="md:w-48">
              <Select value={selectedPatientId} onValueChange={setSelectedPatientId}>
                ...
                <SelectContent>
                  <SelectItem value="all-patients">Todos los pacientes</SelectItem>
                  {patients && patients.map((patient) => (
                    <SelectItem key={patient.id} value={patient.id}>
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-gray-500 text-center mb-4">
                {searchTerm || statusFilter !== 'all' || selectedPatientId !== 'all-patients'
