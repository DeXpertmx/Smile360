...
const navigation = [
  ...
  { name: "Periodontograma", href: "/periodontograma", icon: BarChart3 },
  { name: "Presupuestos", href: "/presupuestos", icon: Calculator },
  { name: "Financiamiento", href: "/financing", icon: CreditCard },
  { name: "Morosidad", href: "/morosidad", icon: AlertTriangle },
  { name: "WhatsApp", href: "/whatsapp", icon: MessageCircle },
  { name: "Aseguradoras", href: "/aseguradoras", icon: Shield },
    ...
    >
          ...
          <AnimatePresence mode="wait">
            {!collapsed && (
              ...
              >
                ...
                <div>
                  <h1 className="text-xl font-bold dental-text-primary">Smile 360</h1>
      ...
      <div className="p-4 border-t border-gray-200 space-y-2">
        <Link href="/portal/login" target="_blank">
          ...
          >
            <Users className={cn("w-5 h-5", collapsed ? "mr-0" : "mr-3")} />
            <AnimatePresence mode="wait">
              {!collapsed && (
                <motion.span
                  key="portal-text"
