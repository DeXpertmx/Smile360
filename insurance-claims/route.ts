  ...
  try {
    ...
    const claim = await prisma.insuranceClaim.create({
      data: {
        ...
        allowedAmount: validatedData.allowedAmount || 0,
        paidAmount: validatedData.paidAmount || 0,
        patientResponsibility: validatedData.patientAmount || 0,
        status: validatedData.status,
        treatmentCode: validatedData.procedureCode,
        treatmentDescription: validatedData.procedureDescription,
        diagnosis: validatedData.diagnosisCode,
        notes: validatedData.notes,
        denialReason: validatedData.rejectionReason,
        submittedBy: session.user.id,
        submissionMethod: 'Electrónico',
      },
      include: {
        patient: {
          select: {
